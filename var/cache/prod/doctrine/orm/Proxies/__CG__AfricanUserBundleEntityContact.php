...
namespace Proxies\__CG__\African\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Contact extends \African\UserBundle\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'African\\UserBundle\\Entity\\Contact' . "\0" . 'id', 'name', 'email', 'subject', 'message', 'createdat', 'updatedat'];
        }
